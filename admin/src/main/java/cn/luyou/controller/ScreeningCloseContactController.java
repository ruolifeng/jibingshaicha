...
public class ScreeningCloseContactController {
    ...
    public void export(HttpServletResponse response) throws Exception {
        ...
        List<ScreeningCloseContact> list = screeningCloseContactService.list(
                Wrappers.<ScreeningCloseContact>lambdaQuery().orderByDesc(ScreeningCloseContact::getCreateTime));
        EasyExcel.write(response.getOutputStream(), ScreeningCloseContact.class).sheet("筛查数据").doWrite(list);
    }
}
