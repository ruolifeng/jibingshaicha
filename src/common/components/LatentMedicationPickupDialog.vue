...
import { saveLatentMedicationPickupApi } from "@/pages/latent-management/apis"
...
async function handleSave() {
  if (!props.latentRow || formLocked.value || saving.value) return
  ...
  try {
    ...
    await saveLatentMedicationPickupApi({
