  ...
  <div class="app-container">
    ...
    <el-card shadow="never">
      ...
      <el-table v-loading="loading" :data="tableData" border stripe max-height="600">
        ...
        <el-table-column prop="occupation" label="职业" width="90" />
        <el-table-column prop="contactType" label="接触类型" width="100" />
        <el-table-column prop="sourcePatientName" label="原患者姓名" width="110" />
        <el-table-column prop="sourcePatientConfirmDate" label="原患者确诊日期" width="140" />
        <el-table-column prop="sourcePatientIdNumber" label="原患者身份证号" width="180" />
        <el-table-column prop="firstScreenDate" label="首次筛查日期" width="130" />
        <el-table-column prop="firstScreenResult" label="首次筛查结果" width="120" />
        <el-table-column prop="halfYearScreenDate" label="半年后筛查日期" width="140" />
        <el-table-column prop="halfYearScreenResult" label="半年后筛查结果" width="130" />
        <el-table-column prop="oneYearScreenDate" label="一年后筛查日期" width="140" />
        <el-table-column prop="oneYearScreenResult" label="一年后筛查结果" width="130" />
        <el-table-column prop="hasInfectionScreen" label="是否感染筛" width="100" />
        <el-table-column prop="screenMethod" label="感染检查方法" width="120" />
        <el-table-column prop="screenResult" label="感染检查结果" width="150" />
        ...
        <el-table-column prop="preventiveTreatment" label="预防性治疗" width="100" />
        <el-table-column prop="treatmentPlan" label="治疗方案" width="150" />
        <el-table-column prop="treatmentStartDate" label="治疗开始时间" width="130" />
        <el-table-column prop="treatmentEndDate" label="治疗完成时间" width="130" />
        <el-table-column prop="treatmentResult" label="治疗结果" width="100" />
        <el-table-column prop="treatmentSupervisor" label="随访管理人员" width="120" />
        <el-table-column prop="benefitMethod" label="惠民方式" width="100" />
