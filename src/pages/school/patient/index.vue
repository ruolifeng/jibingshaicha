      ...
      <el-table v-loading="loading" :data="tableData" border stripe max-height="600">
        ...
        <el-table-column label="操作" fixed="right">
          <template #default="{ row }">
            ...
            <el-button v-permission="'patient:followUp'" type="warning" size="small" @click="openFollowUpDialog(row)">后续随访</el-button>
            <el-button size="small" @click="viewFollowUpList(row)">随访记录</el-button>
            <el-button v-permission="'patient:medication'" type="danger" size="small" @click="openMedicationDialog(row)">服药管理</el-button>
          </template>
        </el-table-column>
      </el-table>
